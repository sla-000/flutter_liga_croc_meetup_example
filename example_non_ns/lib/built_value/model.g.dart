...
class _$BuiltPerson extends BuiltPerson {
  ...
  _$BuiltPerson._({this.name, this.age, this.height}) : super._() {
    if (name == null) {
      throw new BuiltValueNullFieldError('BuiltPerson', 'name');
    }
    if (age == null) {
      throw new BuiltValueNullFieldError('BuiltPerson', 'age');
    }
  }
...
class BuiltPersonBuilder implements Builder<BuiltPerson, BuiltPersonBuilder> {
  ...
  _$BuiltPerson build() {
    final _$result =
        _$v ?? new _$BuiltPerson._(name: name, age: age, height: height);
    replace(_$result);
    return _$result;
  }
}
